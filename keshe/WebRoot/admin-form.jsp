  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
      ...
      <div class="am-tab-panel am-fade" id="tab3">
        <form class="am-form" method="post" action="servlet/warehouse?method=add">
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="ISBN" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题">
            </div>
          </div>
		  ...
		  <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="price" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题">
            </div>
          </div>
		  ...
		  <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="Pub" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题">
            </div>
          </div>
		  ...
		  <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="author" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题">
            </div>
          </div>
		<div class="am-margin">
