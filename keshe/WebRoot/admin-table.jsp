...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">订单信息</strong> / <small>bookorder</small></div>
    </div>
        ...
        <form class="am-form">
          ...
          <div>
        	...
        	for(int i = 0;i < list.size();i++){
        		if(list.get(i).getfinish().equals("ye")){
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a href="servlet/warehouse?method=delete&deleteorderID=<%=list.get(i).getorderNO()%>&userName=<%=u.getUername()%>">
                    <input type = "button" class="am-btn am-btn-default am-btn-xs am-text-danger" value = "完成"></a>
                  </div>
                </div>
              </td>
            </tr>
